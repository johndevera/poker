...
/*
TWO_OF_DIAMONDS(TWO, DIAMOND, "2d", 2),
THREE_OF_DIAMONDS(THREE, DIAMOND, "3d", 3),
FOUR_OF_DIAMONDS(FOUR, DIAMOND, "4d", 4),
FIVE_OF_DIAMONDS(FIVE, DIAMOND, "5d", 5),
SIX_OF_DIAMONDS(SIX, DIAMOND, "6d", 6),
SEVEN_OF_DIAMONDS(SEVEN, DIAMOND, "7d", 7),
EIGHT_OF_DIAMONDS(EIGHT, DIAMOND, "8d", 8),
NINE_OF_DIAMONDS(NINE, DIAMOND, "9d", 9),
TEN_OF_DIAMONDS(TEN, DIAMOND, "Td", 10),
JACK_OF_DIAMONDS(JACK, DIAMOND, "Jd", 11),
QUEEN_OF_DIAMONDS(QUEEN, DIAMOND, "Qd", 12),
KING_OF_DIAMONDS(KING, DIAMOND, "Kd", 13),
ACE_OF_DIAMONDS(ACE, DIAMOND, "Ad", 14),

TWO_OF_CLUBS(TWO, CLUB, "2c", 2),
THREE_OF_CLUBS(THREE, CLUB, "3c", 3),
FOUR_OF_CLUBS(FOUR, CLUB, "4c", 4),
FIVE_OF_CLUBS(FIVE, CLUB, "5c", 5),
SIX_OF_CLUBS(SIX, CLUB, "6c", 6),
SEVEN_OF_CLUBS(SEVEN, CLUB, "7c", 7),
EIGHT_OF_CLUBS(EIGHT, CLUB, "8c", 8),
NINE_OF_CLUBS(NINE, CLUB, "9c", 9),
TEN_OF_CLUBS(TEN, CLUB, "Tc", 10),
JACK_OF_CLUBS(JACK, CLUB, "Jc", 11),
QUEEN_OF_CLUBS(QUEEN, CLUB, "Qc", 12),
KING_OF_CLUBS(KING, CLUB, "Kc", 13),
ACE_OF_CLUBS(ACE, CLUB, "Ac", 14),

TWO_OF_HEARTS(TWO, HEART, "2h", 2),
THREE_OF_HEARTS(THREE, HEART, "3h", 3),
FOUR_OF_HEARTS(FOUR, HEART, "4h", 4),
FIVE_OF_HEARTS(FIVE, HEART, "5h", 5),
SIX_OF_HEARTS(SIX, HEART, "6h", 6),
SEVEN_OF_HEARTS(SEVEN, HEART, "7h", 7),
EIGHT_OF_HEARTS(EIGHT, HEART, "8h", 8),
NINE_OF_HEARTS(NINE, HEART, "9h", 9),
TEN_OF_HEARTS(TEN, HEART, "Th", 10),
JACK_OF_HEARTS(JACK, HEART, "Jh", 11),
QUEEN_OF_HEARTS(QUEEN, HEART, "Qh", 12),
KING_OF_HEARTS(KING, HEART, "Kh", 13),
ACE_OF_HEARTS(ACE, HEART, "Ah", 14),

TWO_OF_SPADES(TWO, SPADE, "2s", 2),
THREE_OF_SPADES(THREE, SPADE, "3s", 3),
FOUR_OF_SPADES(FOUR, SPADE, "4s", 4),
FIVE_OF_SPADES(FIVE, SPADE, "5s", 5),
SIX_OF_SPADES(SIX, SPADE, "6s", 6),
SEVEN_OF_SPADES(SEVEN, SPADE, "7s", 7),
EIGHT_OF_SPADES(EIGHT, SPADE, "8s", 8),
NINE_OF_SPADES(NINE, SPADE, "9s", 9),
TEN_OF_SPADES(TEN, SPADE, "Ts", 10),
JACK_OF_SPADES(JACK, SPADE, "Js", 11),
QUEEN_OF_SPADES(QUEEN, SPADE, "Qs", 12),
KING_OF_SPADES(KING, SPADE, "Ks", 13),
ACE_OF_SPADES(ACE, SPADE, "As", 14);
*/
